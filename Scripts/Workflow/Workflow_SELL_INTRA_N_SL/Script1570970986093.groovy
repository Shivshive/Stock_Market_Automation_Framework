...
WebUI.callTestCase(findTestCase('Utility/Login'), [('userID') : 'R138586', ('password') : 'Shiv123$'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Utility/ToMarket'), [:], FailureHandling.STOP_ON_FAILURE)
...
for (int i = 1; i < totalrows+1; i++) {
    ...
    if (this.OrderType_Sell_Buy.equalsIgnoreCase('sell')) {
        WebUI.callTestCase(findTestCase('Utility/Sell_Limit_Intra_Normal_Stoploss'), [('OrderType_Sell_Buy') : OrderType_Sell_Buy
        ...
        WebUI.callTestCase(findTestCase('Utility/Buy_Limit_Intra_Normal_Stoploss'), [('OrderType_Sell_Buy') : OrderType_Sell_Buy
                , ('OrderType_Normal_Stoploss') : OrderType_Normal_Stoploss, ('TriggerPrice') : TriggerPrice, ('Symbol') : Symbol
                , ('Quantity') : Quantity, ('Price') : Price, ('Disc_Qty') : Disc_Qty], FailureHandling.STOP_ON_FAILURE)
    }
}
